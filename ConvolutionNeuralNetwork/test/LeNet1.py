...
from LR1 import LogisticRegression, load_data, load_test_data, save_predictions
...
class LeNet5(object):
    ...
    def __init__(self, n_conv_layers=2, filter_shapes=((20, 1, 5, 5), (50, 20, 5, 5)),
                 image_shape=(20, 1, 16, 16), poolsize=(2, 2),  n_hidden_neurons = 500,
